...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            if tuote_id == 1:
                ...
                return Tuote(2, "omena", 2)
            elif tuote_id == 3:
                return Tuote(3, "keltainen_kuula", 15)
    ...
    def test_varastosta_loppunut_tuoteeen_lisaamisen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
